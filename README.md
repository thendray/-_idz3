...
Таким образом, программа полученная с использованием флага -O3 проиграывает по памяти ассемблерной программе с использованием регистров, но имеет преимущество перед программой со стеком.
